...
Library.create_passage(%{
  name: "lincoln",
  phrase:
    "four score and seven years ago, our forefathers brought forth a new nation, conceived in liberty and dedicated to the proposition that all men are created equal. Also, never forget, \"Be excellent to each other.... and party on dudes!\"",
  steps: 6
})
